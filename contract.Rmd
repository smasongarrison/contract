...
- [ ] `r advdate(dayone, 2, topic)`
  ...
  - Propose your contract to Mason by `r advdate(dayone, 2, assignment="f")`
...
- [ ] `r advdate(dayone, 6, topic)`
  ...
  - Schedule a check-in with Mason by `r advdate(dayone, 6, assignment="f")`
...
- [ ] `r advdate(dayone, 11, topic)`
  `r if(params$labs>=11) paste0(" - Finish Lab 11 by ",advdate(dayone, 11, assignment="f"))`
  - Finish portfolio piece 5 by `r advdate(dayone, 11, assignment="f")`
- [ ] `r advdate(dayone, 12, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",advdate(dayone, 12, assignment="f"))`
  - Finish portfolio piece 6 by `r advdate(dayone, 12, assignment="f")`
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0(" - Finish Lab 13 by ",advdate(dayone, 13, assignment="f"))`
